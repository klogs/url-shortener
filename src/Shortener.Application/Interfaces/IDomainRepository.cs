...
public interface IDomainRepository
{
    ...
    Task<TenantDomain?> GetActiveByIdAsync(Guid id, Guid tenantId, CancellationToken ct = default);
    Task<int> CountCustomByTenantAsync(Guid tenantId, CancellationToken ct = default);
    ...
    Task SetDefaultAsync(Guid domainId, Guid tenantId, CancellationToken ct = default);
}
